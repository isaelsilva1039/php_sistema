                        ...
                        <div class="card-body">
                            <div class="shadow p-3 mb-5  cad_wms1">
                                ...
                                <div>
                                    ...
                                    <h3>
                                        <i class="mdi mdi-account ajusteIcad colormorador"
                            ...
                            <div class="shadow p-3 mb-5  cad_wms3">
                                ...
                                <div>
                                    <h3><i class="mdi mdi-account-card-details"
                                           style="color:darkslategrey; float:left;color:blue"></i>
                                    </h3>
                                </div>
                                ...
                                <div>
                                    <h3>
                                        <i class="mdi mdi-cash"
                                           style="color:darkslategrey; float:left ;color:rebeccapurple"></i>
                                    </h3>
                                </div>
                                <div>
