                                    ...
                                    <div class="form-group">
                                        <form action="valida_cadastro_erro.php" method="POST">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" hidden value="<?php echo $_SESSION['nome'] ?>">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="usuarioerro" placeholder="Usuario colaborador que erro">
                                            </div>

                                            <div class="form-group">
                                                <label>Nome Do Colaborado</label>
                                                <input type="text" class="form-control" name="nomeerrocolaborador" placeholder="Nome colaborador que erro">
                                            </div>
