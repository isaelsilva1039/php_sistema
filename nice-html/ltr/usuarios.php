                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal form-material">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="nome" required="Campo Nome Obrigatorio" placeholder="Nome..." class="form-control form-control-line">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="email" required="Campo Nome Email Obrigatorio" placeholder="E-mail..." class="form-control  form-control-line" name="email" id="example-email">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-12">Senha</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Digite Sua Senha" class="form-control form-control-line" required="Campo Senha Obrigatorio" class="senha" name="senha">
                                                    </div>
                                                </div>
                                                <div class="form-group">
