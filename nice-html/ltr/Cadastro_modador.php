    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="../../controlle/controle_cadastro_morador.php">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationTooltip03">Data Entrada</label>
                                            <input type="date" class="form-control" name="data_entrada" id="validationTooltip03" required>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="validationTooltip04">Bloco</label>
                                            <select class="custom-select" id="validationTooltip04" name="bloco" required>
                                                <option selected disabled value="">Seleione...</option>
                                                <?php foreach ($listaCondominio->listaDeuBlocosOpcao() as $list) : {
                                                    } ?>
                                                    <option><?php echo $list['bloco'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                            <div class="invalid-tooltip">
                                                selecione Um Bloco
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="validationTooltip04">Apartamento</label>
                                            <select class="custom-select" name="apartamento" id="validationTooltip04" required>
                                                <option selected disabled value="">Seleione...</option>
                                                <?php foreach ($listaCondominio->listaDeuBlocosOpcao() as $list) : {
                                                    } ?>
                                                    <option><?php echo $list['apartamento'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                            <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="validationTooltip04">Nivel</label>
                                            <select class="custom-select" name="nivel" id="validationTooltip04" required>
                                                <option selected disabled value="">Seleione...</option>
                                                <?php foreach ($listaCondominio->listaDeuBlocosOpcao() as $list) : {
                                                    } ?>
                                                    <option><?php echo $list['nivel'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                            <div class="invalid-tooltip">
                                                selecione Um nivel
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="validationTooltip02"><I style="color: red;">R$</I> Valor Aluguel </label>
                                            <input type="numbre" class="form-control" name="aluguel" data-size="small" mask="#00.000.000,00" data-only-numbers="" placeholder="Qual O Valor do aluguel">
                                            <div class="valid-tooltip">
                                                Preencha o valor do alugiel
                                            </div>
                                        </div>
                                    </div>
