                            ...
                            <div class="card-body">
                                <div class="table-responsive m-t-20">
                                    ...
                                    <table class="table table-bordered table-responsive-lg">
                                        ...
                                        <?php
                                        foreach ($relatrofuncionarios->RelatorioMoradores($cargo) as $lista) :
                                        ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $lista['data_entrada'] ?></td>
                                                <td><?php echo $lista['bloco'] ?></td>
                                                <td><?php echo $lista['apartamento'] ?></td>
                                                <td><?php echo $lista['nivel'] ?></td>
                                                <td><?php echo "R$" . " " . $lista['aluguel'] ?></td>
                                                <td>
                                                    <form style="float: left ;" method="POST"
                                                        action="../../Controlle/Controle_edita_funcionario.php">
                                                    ...
                                                    <form style="float: left ;" method="POST"
                                                        action="controle_deleta_morador.php">
                                                        <button class="btnAcoesexcluir" name="id"
                                                            value="<?= $lista['id'] ?>">
