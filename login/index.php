...
<div class=" fadeInDown ">
    ...
    <div class="m">
        <img class="img"
             src="https://raw.githubusercontent.com/giovannamoeller/sign-up-form/aadfbbecbd1c65121767d3630678044b85125763/assets/mobile.svg"> </img>
    </div>

    <?php
    if (isset($_GET['erro'])) : ?>
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Senha Errada!</strong> Se você não tem usuario, falar com O suporte <strong> (99)
                992292338. </strong>
